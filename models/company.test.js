...
describe("findAll", function () {
  ...
  test("works: filter by min and maxEmployees and name", async function () {
  ...
  test("works: no matching results", async function () {
    let companies = await Company.findAll({ name: "doesn't exist" });
    expect(companies).toEqual([]);
  });
